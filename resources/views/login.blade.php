          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Hello! Selamat Datang di Aplikasi Pembayaran SPP</h4>
                <h6 class="font-weight-light">Login Untuk Memulai</h6>
                <form class="pt-3" action="{{ route('login') }}" method="post">
                    @csrf
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" value="{{ Session::get('username') }}" name="username" Placeholder="Username">
                  </div>
                  @error('username')
